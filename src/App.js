...
import PostJainOnline from "./Components/Post/PostJainOnline";
function App() {
  return (
    <Router>
      <Navbar />
      ...
      <Route
        exact
        path="/annamalaiuniversity"
        component={AnnamalaiUniversity}
      />
      <Route
        exact
        path="/singhaniauniversity"
        component={SinghaniaUniversity}
      />
